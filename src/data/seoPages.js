...
const coreServicesDe = [
  ...
  },
  {
    ...
    highlights: ['Nach ISO 17100', 'Vier-Augen-Prinzip', '190+ Sprachen'],
    sections: [
...
const multilingualBase = {
  en: {
    ...
    specialist: {
      ...
      highlights: ['ISO 17100-aligned', 'Terminology', '190+ languages'],
  ...
  ar: {
    ...
    specialist: {
      ...
      highlights: ['وفق ISO 17100', 'مصطلحات دقيقة', '190+ لغة'],
  ...
  tr: {
    ...
    specialist: {
      ...
      highlights: ['ISO 17100’e göre', 'Terminoloji', '190+ dil'],
