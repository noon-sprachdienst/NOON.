...
Object.assign(SERVICE_SHEET_TEXT_TRANSLATIONS, {
  'Internationaler Geschäftsverkehr': { en: 'International business', ar: 'المعاملات التجارية الدولية', tr: 'Uluslararası ticari işlemler', ru: 'Международная деловая деятельность', fr: 'Commerce international', uk: 'Міжнародна ділова діяльність' },
  'Banken & Versicherungen': { en: 'Banks and insurance', ar: 'البنوك والتأمين', tr: 'Bankalar ve sigortalar', ru: 'Банки и страхование', fr: 'Banques et assurances', uk: 'Банки та страхування' },
  'Bilanzierung & Controlling': { en: 'Accounting and controlling', ar: 'المحاسبة والرقابة المالية', tr: 'Muhasebe ve kontrol', ru: 'Бухгалтерский учет и контроллинг', fr: 'Comptabilité et contrôle de gestion', uk: 'Бухгалтерський облік і контролінг' },
  'Verträge & Compliance': { en: 'Contracts and compliance', ar: 'العقود والامتثال', tr: 'Sözleşmeler ve uyum', ru: 'Договоры и комплаенс', fr: 'Contrats et conformité', uk: 'Договори та комплаєнс' },
  'Zu den Dokumenten, die wir täglich beglaubigt übersetzen, gehören insbesondere:': { en: 'The documents we translate with certification every day include in particular:', ar: 'من بين الوثائق التي نترجمها ترجمة معتمدة يوميا على وجه الخصوص:', tr: 'Her gün yeminli olarak çevirdiğimiz belgeler özellikle şunları içerir:', ru: 'К документам, которые мы ежедневно переводим с заверением, в частности, относятся:', fr: 'Parmi les documents que nous traduisons avec certification chaque jour figurent notamment :', uk: 'До документів, які ми щодня перекладаємо із засвідченням, зокрема, належать:' },
  'Zu unseren häufigsten Sprachkombinationen gehören:': { en: 'Our most common language combinations include:', ar: 'من بين أكثر أزواجنا اللغوية شيوعا:', tr: 'En sık kullandığımız dil kombinasyonları şunlardır:', ru: 'К нашим наиболее частым языковым комбинациям относятся:', fr: 'Nos combinaisons linguistiques les plus fréquentes comprennent :', uk: 'До наших найпоширеніших мовних комбінацій належать:' },
  'So einfach läuft Ihre beglaubigte Übersetzung ab': { en: 'This is how easy your certified translation is', ar: 'بهذه البساطة تتم ترجمتك المعتمدة', tr: 'Yeminli çeviriniz bu kadar kolay ilerliyor', ru: 'Вот как просто оформляется ваш заверенный перевод', fr: 'Voici à quel point votre traduction certifiée est simple', uk: 'Ось як просто оформлюється ваш засвідчений переклад' },
  'Behördlich anerkannt': { en: 'Officially recognized', ar: 'معترف به رسميا', tr: 'Resmî olarak tanınır', ru: 'Официально признано', fr: 'Reconnu par les autorités', uk: 'Офіційно визнано' },
  'Vier-Augen-Prinzip': { en: 'Four-eyes principle', ar: 'مبدأ المراجعة المزدوجة', tr: 'Dört göz ilkesi', ru: 'Принцип двойного контроля', fr: 'Principe du double contrôle', uk: 'Принцип подвійного контролю' },
  'Terminologiemanagement': { en: 'Terminology management', ar: 'إدارة المصطلحات', tr: 'Terminoloji yönetimi', ru: 'Управление терминологией', fr: 'Gestion terminologique', uk: 'Управління термінологією' },
  'Versand deutschlandweit': { en: 'Delivery throughout Germany', ar: 'الشحن في جميع أنحاء ألمانيا', tr: 'Almanya genelinde gönderim', ru: 'Доставка по всей Германии', fr: 'Envoi dans toute l’Allemagne', uk: 'Доставка по всій Німеччині' },
});

// Completeness pass: entries that previously fell back to English for tr/ru/fr/uk.
Object.assign(SERVICE_SHEET_TEXT_TRANSLATIONS, {
  'Fachinformationen (SmPC)': { en: 'Product information (SmPC)', ar: 'معلومات المنتج (SmPC)', tr: 'Ürün bilgisi (SmPC)', ru: 'Инструкция по применению (SmPC)', fr: 'Résumé des caractéristiques du produit (SmPC)', uk: 'Інструкція для медичного застосування (SmPC)' },
  'Packungsbeilagen (PIL)': { en: 'Package leaflets (PIL)', ar: 'النشرات الداخلية (PIL)', tr: 'Kullanma talimatları (PIL)', ru: 'Листки-вкладыши (PIL)', fr: 'Notices (PIL)', uk: 'Листки-вкладиші (PIL)' },
  'Arzneimittelverpackungen': { en: 'Medicine packaging', ar: 'عبوات الأدوية', tr: 'İlaç ambalajları', ru: 'Упаковка лекарственных средств', fr: 'Emballages de médicaments', uk: 'Упаковка лікарських засобів' },
  'Etiketten & Faltschachteln': { en: 'Labels and folding cartons', ar: 'الملصقات والعلب المطوية', tr: 'Etiketler ve katlanır kutular', ru: 'Этикетки и складные коробки', fr: 'Étiquettes et étuis pliants', uk: 'Етикетки та складані коробки' },
  'Zulassungsunterlagen': { en: 'Approval documents', ar: 'وثائق الترخيص', tr: 'Ruhsat belgeleri', ru: 'Регистрационные документы', fr: 'Dossiers d’autorisation', uk: 'Реєстраційні документи' },
  'Einreichungsdossiers': { en: 'Submission dossiers', ar: 'ملفات التقديم', tr: 'Başvuru dosyaları', ru: 'Регистрационные досье', fr: 'Dossiers de soumission', uk: 'Реєстраційні досьє' },
  'Patienteninformationen': { en: 'Patient information', ar: 'معلومات المرضى', tr: 'Hasta bilgileri', ru: 'Информация для пациентов', fr: 'Informations patients', uk: 'Інформація для пацієнтів' },
  'GMP-Dokumente': { en: 'GMP documents', ar: 'وثائق GMP', tr: 'GMP belgeleri', ru: 'GMP-документы', fr: 'Documents GMP', uk: 'GMP-документи' },
  'SOPs & Arbeitsanweisungen': { en: 'SOPs and work instructions', ar: 'إجراءات التشغيل القياسية وتعليمات العمل', tr: 'SOP’lar ve çalışma talimatları', ru: 'СОП и рабочие инструкции', fr: 'SOP et instructions de travail', uk: 'СОП та робочі інструкції' },
  'Internationale Pharma- und Zulassungsprojekte': { en: 'International pharmaceutical and approval projects', ar: 'مشاريع صيدلانية وترخيص دولية', tr: 'Uluslararası ilaç ve ruhsatlandırma projeleri', ru: 'Международные фармацевтические и регистрационные проекты', fr: 'Projets pharmaceutiques et d’autorisation internationaux', uk: 'Міжнародні фармацевтичні та реєстраційні проєкти' },
  'Internationale Arzneimittelzulassungen': { en: 'International medicine approvals', ar: 'تراخيص أدوية دولية', tr: 'Uluslararası ilaç ruhsatlandırmaları', ru: 'Международные регистрации лекарств', fr: 'Autorisations internationales de médicaments', uk: 'Міжнародні реєстрації лікарських засобів' },
  'GMP-Dokumentationen': { en: 'GMP documentation', ar: 'وثائق GMP', tr: 'GMP dokümantasyonu', ru: 'GMP-документация', fr: 'Documentation GMP', uk: 'GMP-документація' },
  'Medizinprodukte': { en: 'Medical devices', ar: 'الأجهزة الطبية', tr: 'Tıbbi cihazlar', ru: 'Медицинские изделия', fr: 'Dispositifs médicaux', uk: 'Медичні вироби' },
  'Pharmakovigilanz': { en: 'Pharmacovigilance', ar: 'اليقظة الدوائية', tr: 'Farmakovijilans', ru: 'Фармаконадзор', fr: 'Pharmacovigilance', uk: 'Фармаконагляд' },
  'Mehrsprachige Produktdokumentationen': { en: 'Multilingual product documentation', ar: 'وثائق منتجات متعددة اللغات', tr: 'Çok dilli ürün dokümantasyonu', ru: 'Многоязычная документация на продукцию', fr: 'Documentation produit multilingue', uk: 'Багатомовна документація на продукцію' },
  'Arzneimittelübersetzungen': { en: 'Medicine translations', ar: 'ترجمات الأدوية', tr: 'İlaç çevirileri', ru: 'Переводы лекарственных средств', fr: 'Traductions de médicaments', uk: 'Переклади лікарських засобів' },
  'Klinische Forschung': { en: 'Clinical research', ar: 'البحث السريري', tr: 'Klinik araştırma', ru: 'Клинические исследования', fr: 'Recherche clinique', uk: 'Клінічні дослідження' },
  'Pharma & Biotechnologie': { en: 'Pharma and biotechnology', ar: 'الصيدلة والتكنولوجيا الحيوية', tr: 'İlaç ve biyoteknoloji', ru: 'Фармацевтика и биотехнология', fr: 'Pharma et biotechnologie', uk: 'Фармацевтика та біотехнологія' },
  'Literarische Fachübersetzungen': { en: 'Literary specialist translations', ar: 'ترجمات أدبية متخصصة', tr: 'Edebi uzman çeviriler', ru: 'Литературные специализированные переводы', fr: 'Traductions littéraires spécialisées', uk: 'Літературні фахові переклади' },
  'Literarische und kulturelle Texte': { en: 'Literary and cultural texts', ar: 'نصوص أدبية وثقافية', tr: 'Edebi ve kültürel metinler', ru: 'Литературные и культурные тексты', fr: 'Textes littéraires et culturels', uk: 'Літературні та культурні тексти' },
  'Romane': { en: 'Novels', ar: 'الروايات', tr: 'Romanlar', ru: 'Романы', fr: 'Romans', uk: 'Романи' },
  'Erzählungen': { en: 'Short stories', ar: 'القصص', tr: 'Öyküler', ru: 'Рассказы', fr: 'Nouvelles', uk: 'Оповідання' },
  'Kinder- und Jugendbücher': { en: 'Children’s and young adult books', ar: 'كتب الأطفال واليافعين', tr: 'Çocuk ve gençlik kitapları', ru: 'Книги для детей и юношества', fr: 'Livres pour enfants et jeunes', uk: 'Книги для дітей та юнацтва' },
  'Lyrik': { en: 'Poetry', ar: 'الشعر', tr: 'Şiir', ru: 'Поэзия', fr: 'Poésie', uk: 'Поезія' },
  'Essays': { en: 'Essays', ar: 'المقالات الأدبية', tr: 'Denemeler', ru: 'Эссе', fr: 'Essais', uk: 'Есеї' },
  'Biografien': { en: 'Biographies', ar: 'السير الذاتية', tr: 'Biyografiler', ru: 'Биографии', fr: 'Biographies', uk: 'Біографії' },
  'Sachbücher': { en: 'Non-fiction books', ar: 'كتب غير روائية', tr: 'Kurgu dışı kitaplar', ru: 'Научно-популярные книги', fr: 'Ouvrages non romanesques', uk: 'Науково-популярні книги' },
  'Theaterstücke': { en: 'Plays', ar: 'المسرحيات', tr: 'Tiyatro oyunları', ru: 'Пьесы', fr: 'Pièces de théâtre', uk: 'Театральні п’єси' },
  'Drehbücher': { en: 'Screenplays', ar: 'السيناريوهات', tr: 'Senaryolar', ru: 'Сценарии', fr: 'Scénarios', uk: 'Сценарії' },
  'Hörspieltexte': { en: 'Radio play texts', ar: 'نصوص المسرحيات الصوتية', tr: 'Radyo oyunu metinleri', ru: 'Тексты радиоспектаклей', fr: 'Textes de pièces radiophoniques', uk: 'Тексти радіоп’єс' },
  'Katalogtexte': { en: 'Catalogue texts', ar: 'نصوص الكتالوجات', tr: 'Katalog metinleri', ru: 'Тексты каталогов', fr: 'Textes de catalogue', uk: 'Тексти каталогів' },
  'Ausstellungstexte': { en: 'Exhibition texts', ar: 'نصوص المعارض', tr: 'Sergi metinleri', ru: 'Тексты выставок', fr: 'Textes d’exposition', uk: 'Тексти виставок' },
  'Verlage, Autoren & Kulturinstitutionen': { en: 'Publishers, authors and cultural institutions', ar: 'دور النشر والمؤلفون والمؤسسات الثقافية', tr: 'Yayınevleri, yazarlar ve kültür kurumları', ru: 'Издательства, авторы и учреждения культуры', fr: 'Éditeurs, auteurs et institutions culturelles', uk: 'Видавництва, автори та культурні установи' },
  'Buchübersetzungen': { en: 'Book translations', ar: 'ترجمات الكتب', tr: 'Kitap çevirileri', ru: 'Переводы книг', fr: 'Traductions de livres', uk: 'Переклади книг' },
  'Literaturprojekte': { en: 'Literary projects', ar: 'مشاريع أدبية', tr: 'Edebiyat projeleri', ru: 'Литературные проекты', fr: 'Projets littéraires', uk: 'Літературні проєкти' },
  'Verlagsprogramme': { en: 'Publishing programmes', ar: 'برامج النشر', tr: 'Yayın programları', ru: 'Издательские программы', fr: 'Programmes éditoriaux', uk: 'Видавничі програми' },
  'Theaterproduktionen': { en: 'Theatre productions', ar: 'إنتاجات مسرحية', tr: 'Tiyatro yapımları', ru: 'Театральные постановки', fr: 'Productions théâtrales', uk: 'Театральні постановки' },
  'Filmproduktionen': { en: 'Film productions', ar: 'إنتاجات سينمائية', tr: 'Film yapımları', ru: 'Кинопроизводство', fr: 'Productions cinématographiques', uk: 'Кінопродукція' },
  'Museumsausstellungen': { en: 'Museum exhibitions', ar: 'معارض المتاحف', tr: 'Müze sergileri', ru: 'Музейные выставки', fr: 'Expositions muséales', uk: 'Музейні виставки' },
  'Mehrsprachige Marketingkampagnen': { en: 'Multilingual marketing campaigns', ar: 'حملات تسويقية متعددة اللغات', tr: 'Çok dilli pazarlama kampanyaları', ru: 'Многоязычные маркетинговые кампании', fr: 'Campagnes marketing multilingues', uk: 'Багатомовні маркетингові кампанії' },
  'Internationale Kulturprojekte': { en: 'International cultural projects', ar: 'مشاريع ثقافية دولية', tr: 'Uluslararası kültür projeleri', ru: 'Международные культурные проекты', fr: 'Projets culturels internationaux', uk: 'Міжнародні культурні проєкти' },
  'Kultur & Medien': { en: 'Culture and media', ar: 'الثقافة والإعلام', tr: 'Kültür ve medya', ru: 'Культура и медиа', fr: 'Culture et médias', uk: 'Культура та медіа' },
  'Lektorat & Korrektorat': { en: 'Editing and proofreading', ar: 'التحرير والتدقيق اللغوي', tr: 'Redaksiyon ve düzelti', ru: 'Редактура и корректура', fr: 'Révision et correction', uk: 'Редагування та коректура' },
  'Verträge': { en: 'Contracts', ar: 'العقود', tr: 'Sözleşmeler', ru: 'Договоры', fr: 'Contrats', uk: 'Договори' },
  'Gesellschaftsverträge': { en: 'Articles of association', ar: 'عقود الشركات', tr: 'Şirket sözleşmeleri', ru: 'Учредительные договоры', fr: 'Statuts de société', uk: 'Установчі договори' },
  'Vollmachten': { en: 'Powers of attorney', ar: 'التوكيلات', tr: 'Vekaletnameler', ru: 'Доверенности', fr: 'Procurations', uk: 'Довіреності' },
  'Gerichtsurteile': { en: 'Court judgments', ar: 'الأحكام القضائية', tr: 'Mahkeme kararları', ru: 'Судебные решения', fr: 'Jugements', uk: 'Судові рішення' },
  'Beschlüsse': { en: 'Decisions', ar: 'القرارات', tr: 'Kararlar', ru: 'Постановления', fr: 'Décisions', uk: 'Постанови' },
  'Satzungen': { en: 'Statutes', ar: 'الأنظمة الأساسية', tr: 'Tüzükler', ru: 'Уставы', fr: 'Statuts', uk: 'Статути' },
  'Klageschriften': { en: 'Statements of claim', ar: 'لوائح الدعوى', tr: 'Dava dilekçeleri', ru: 'Исковые заявления', fr: 'Actes de procédure', uk: 'Позовні заяви' },
  'Notarielle Urkunden': { en: 'Notarial deeds', ar: 'الوثائق الموثقة', tr: 'Noter belgeleri', ru: 'Нотариальные документы', fr: 'Actes notariés', uk: 'Нотаріальні документи' },
});

// Completeness pass: long body paragraphs that previously fell back to English for tr/ru/fr/uk.
Object.assign(SERVICE_SHEET_TEXT_TRANSLATIONS, {
  'Unsere Simultandolmetscher sorgen dafür, dass internationale Konferenzen, Tagungen und Veranstaltungen reibungslos mehrsprachig ablaufen.': { en: 'Our simultaneous interpreters ensure that international conferences, meetings and events run smoothly in several languages.', ar: 'يضمن مترجمونا الفوريون المتزامنون سير المؤتمرات والاجتماعات والفعاليات الدولية بسلاسة بعدة لغات.', tr: 'Simultane tercümanlarımız, uluslararası konferansların, toplantıların ve etkinliklerin çok dilli olarak sorunsuz ilerlemesini sağlar.', ru: 'Наши синхронные переводчики обеспечивают беспрепятственное многоязычное проведение международных конференций, совещаний и мероприятий.', fr: 'Nos interprètes simultanés veillent au bon déroulement multilingue des conférences, réunions et événements internationaux.', uk: 'Наші синхронні перекладачі забезпечують безперешкодне багатомовне проведення міжнародних конференцій, нарад і заходів.' },
  'Wir bieten professionelles Echtzeit-Dolmetschen unter anderem in den Sprachkombinationen:': { en: 'We offer professional real-time interpreting, including the following language combinations:', ar: 'نقدم ترجمة فورية مباشرة احترافية، من بينها الأزواج اللغوية التالية:', tr: 'Diğerlerinin yanı sıra aşağıdaki dil kombinasyonlarında profesyonel gerçek zamanlı tercümanlık sunuyoruz:', ru: 'Мы предлагаем профессиональный синхронный перевод в реальном времени, в частности, в следующих языковых комбинациях:', fr: 'Nous proposons une interprétation professionnelle en temps réel, notamment dans les combinaisons linguistiques suivantes :', uk: 'Ми пропонуємо професійний переклад у реальному часі, зокрема, у таких мовних комбінаціях:' },
  'sowie in vielen weiteren europäischen und außereuropäischen Sprachen': { en: 'as well as many other European and non-European languages', ar: 'وكذلك العديد من اللغات الأوروبية وغير الأوروبية الأخرى', tr: 've ayrıca birçok başka Avrupa ve Avrupa dışı dilde', ru: 'а также на многих других европейских и неевропейских языках', fr: 'ainsi que dans de nombreuses autres langues européennes et non européennes', uk: 'а також багатьма іншими європейськими та неєвропейськими мовами' },
  'Wir vermitteln qualifizierte Dolmetscher in über 190 Sprachen für Präsenztermine, Online-Meetings, Videokonferenzen und Telefondolmetschen – schnell, zuverlässig und professionell.': { en: 'We arrange qualified interpreters in more than 190 languages for on-site appointments, online meetings, video conferences and telephone interpreting, quickly, reliably and professionally.', ar: 'نوفر مترجمين فوريين مؤهلين بأكثر من 190 لغة للمواعيد الحضورية والاجتماعات عبر الإنترنت ومؤتمرات الفيديو والترجمة الهاتفية، بسرعة وموثوقية واحترافية.', tr: '190’dan fazla dilde nitelikli tercümanları yüz yüze randevular, çevrimiçi toplantılar, video konferanslar ve telefon tercümanlığı için hızlı, güvenilir ve profesyonel şekilde temin ediyoruz.', ru: 'Мы предоставляем квалифицированных устных переводчиков на более чем 190 языках для очных встреч, онлайн-совещаний, видеоконференций и телефонного перевода — быстро, надежно и профессионально.', fr: 'Nous mettons à disposition des interprètes qualifiés dans plus de 190 langues pour des rendez-vous en présentiel, des réunions en ligne, des visioconférences et de l’interprétation téléphonique — rapidement, de manière fiable et professionnelle.', uk: 'Ми надаємо кваліфікованих усних перекладачів понад 190 мовами для очних зустрічей, онлайн-нарад, відеоконференцій і телефонного перекладу — швидко, надійно та професійно.' },
  'Bei notariellen Beurkundungen – etwa Kaufverträgen, Eheverträgen, Gesellschaftsgründungen oder Vollmachten – ist präzises Dolmetschen unverzichtbar.': { en: 'Precise interpreting is essential for notarial certifications such as purchase contracts, marriage contracts, company formations or powers of attorney.', ar: 'في التصديقات التوثيقية مثل عقود البيع أو عقود الزواج أو تأسيس الشركات أو التوكيلات، تكون الترجمة الفورية الدقيقة أمرا ضروريا.', tr: 'Satış sözleşmeleri, evlilik sözleşmeleri, şirket kuruluşları veya vekaletnameler gibi noter tasdiklerinde hassas tercümanlık vazgeçilmezdir.', ru: 'При нотариальном удостоверении — например, договоров купли-продажи, брачных договоров, учреждения компаний или доверенностей — точный устный перевод незаменим.', fr: 'Lors d’actes notariés — tels que contrats de vente, contrats de mariage, constitutions de sociétés ou procurations — une interprétation précise est indispensable.', uk: 'Під час нотаріальних посвідчень — наприклад, договорів купівлі-продажу, шлюбних договорів, заснування компаній чи довіреностей — точний усний переклад є незамінним.' },
  'Unsere Notardolmetscher arbeiten regelmäßig mit Notariaten zusammen und sind mit den Abläufen vor Ort bestens vertraut.': { en: 'Our notary interpreters regularly work with notary offices and are highly familiar with local procedures.', ar: 'يعمل مترجمو كاتب العدل لدينا بانتظام مع مكاتب التوثيق وهم على دراية كاملة بالإجراءات المتبعة هناك.', tr: 'Noter tercümanlarımız düzenli olarak noterliklerle çalışır ve yerel işleyişe son derece aşinadır.', ru: 'Наши нотариальные переводчики регулярно сотрудничают с нотариальными конторами и прекрасно знакомы с местными процедурами.', fr: 'Nos interprètes notariaux collaborent régulièrement avec des études notariales et connaissent parfaitement les procédures sur place.', uk: 'Наші нотаріальні перекладачі регулярно співпрацюють з нотаріальними конторами й чудово обізнані з місцевими процедурами.' },
  'Fachübersetzungen erfordern weit mehr als Sprachkenntnisse. Sie setzen fundiertes Fachwissen und Erfahrung im jeweiligen Fachgebiet voraus. Deshalb arbeiten wir ausschließlich mit qualifizierten Fachübersetzern.': { en: 'Specialist translations require much more than language skills. They require sound subject knowledge and experience in the relevant field. That is why we work exclusively with qualified specialist translators.', ar: 'تتطلب الترجمات المتخصصة أكثر بكثير من المعرفة اللغوية؛ فهي تحتاج إلى معرفة تخصصية راسخة وخبرة في المجال المعني. لذلك نعمل حصرا مع مترجمين متخصصين مؤهلين.', tr: 'Uzman çeviriler dil bilgisinden çok daha fazlasını gerektirir. İlgili alanda sağlam uzmanlık bilgisi ve deneyim gerektirir. Bu nedenle yalnızca nitelikli uzman çevirmenlerle çalışıyoruz.', ru: 'Специализированные переводы требуют гораздо большего, чем знание языка. Они предполагают глубокие профессиональные знания и опыт в соответствующей области. Поэтому мы работаем исключительно с квалифицированными специализированными переводчиками.', fr: 'Les traductions spécialisées exigent bien plus que des compétences linguistiques. Elles requièrent des connaissances approfondies et de l’expérience dans le domaine concerné. C’est pourquoi nous travaillons exclusivement avec des traducteurs spécialisés qualifiés.', uk: 'Фахові переклади вимагають набагато більше, ніж знання мови. Вони передбачають ґрунтовні фахові знання та досвід у відповідній галузі. Тому ми працюємо виключно з кваліфікованими фаховими перекладачами.' },
  'Unsere Fachübersetzer übertragen Inhalte sprachlich korrekt, fachlich präzise und zielgruppengerecht – für technische, juristische, medizinische, wissenschaftliche und wirtschaftliche Dokumente.': { en: 'Our specialist translators render content linguistically correctly, technically precisely and appropriately for the target audience, for technical, legal, medical, scientific and business documents.', ar: 'ينقل مترجمونا المتخصصون المحتوى بدقة لغوية وتخصصية وبما يناسب الجمهور المستهدف، للوثائق التقنية والقانونية والطبية والعلمية والاقتصادية.', tr: 'Uzman çevirmenlerimiz içerikleri dilsel olarak doğru, teknik açıdan hassas ve hedef kitleye uygun şekilde aktarır — teknik, hukuki, tıbbi, bilimsel ve ekonomik belgeler için.', ru: 'Наши специализированные переводчики передают содержание грамотно, профессионально точно и с учетом целевой аудитории — для технических, юридических, медицинских, научных и экономических документов.', fr: 'Nos traducteurs spécialisés transposent les contenus avec exactitude linguistique, précision technique et adaptation au public cible — pour des documents techniques, juridiques, médicaux, scientifiques et économiques.', uk: 'Наші фахові перекладачі передають зміст мовно правильно, фахово точно та з урахуванням цільової аудиторії — для технічних, юридичних, медичних, наукових та економічних документів.' },
  'Als Fachübersetzungsbüro für Technik und Ingenieurwesen unterstützen wir Hersteller, Ingenieurbüros, Planungsbüros, Maschinenbauer und Industrieunternehmen mit präzisen technischen Übersetzungen.': { en: 'As a specialist translation office for technology and engineering, we support manufacturers, engineering offices, planning offices, machine builders and industrial companies with precise technical translations.', ar: 'بصفتنا مكتب ترجمة متخصصا في التقنية والهندسة، ندعم المصنّعين والمكاتب الهندسية ومكاتب التخطيط وشركات بناء الآلات والشركات الصناعية بترجمات تقنية دقيقة.', tr: 'Teknik ve mühendislik alanında uzman çeviri bürosu olarak üreticileri, mühendislik bürolarını, planlama bürolarını, makine üreticilerini ve sanayi şirketlerini hassas teknik çevirilerle destekliyoruz.', ru: 'Как специализированное бюро переводов для техники и инженерии, мы поддерживаем производителей, инженерные и проектные бюро, машиностроителей и промышленные предприятия точными техническими переводами.', fr: 'En tant que bureau de traduction spécialisé en technique et ingénierie, nous accompagnons fabricants, bureaux d’ingénierie, bureaux d’études, constructeurs de machines et entreprises industrielles avec des traductions techniques précises.', uk: 'Як спеціалізоване бюро перекладів для техніки та інженерії, ми підтримуємо виробників, інженерні та проєктні бюро, машинобудівників і промислові підприємства точними технічними перекладами.' },
  'Unsere technischen Fachübersetzungen werden von qualifizierten Übersetzern mit ingenieurwissenschaftlichem Hintergrund angefertigt. Als Muttersprachler ihrer jeweiligen Zielsprache verbinden sie technisches Fachwissen mit sprachlicher Präzision und einer einheitlichen Fachterminologie. So erhalten Sie hochwertige, fachlich korrekte und verständliche Übersetzungen – alles aus einer Hand.': { en: 'Our technical specialist translations are prepared by qualified translators with an engineering background. As native speakers of the target language, they combine technical expertise with linguistic precision and consistent terminology, giving you high-quality, correct and clear translations from one source.', ar: 'تُنجز ترجماتنا التقنية المتخصصة بواسطة مترجمين مؤهلين ذوي خلفية هندسية. وبصفتهم متحدثين أصليين للغة الهدف، يجمعون بين المعرفة التقنية والدقة اللغوية والمصطلحات الموحدة، لتحصلوا على ترجمات عالية الجودة ودقيقة ومفهومة من جهة واحدة.', tr: 'Teknik uzman çevirilerimiz, mühendislik geçmişine sahip nitelikli çevirmenler tarafından hazırlanır. Hedef dillerinin ana dili konuşanları olarak teknik uzmanlığı dilsel hassasiyet ve tutarlı bir uzman terminolojisiyle birleştirirler. Böylece yüksek kaliteli, teknik açıdan doğru ve anlaşılır çevirileri tek elden elde edersiniz.', ru: 'Наши технические специализированные переводы выполняются квалифицированными переводчиками с инженерным образованием. Будучи носителями целевого языка, они сочетают техническую экспертизу с языковой точностью и единой специализированной терминологией. Так вы получаете качественные, профессионально корректные и понятные переводы из одних рук.', fr: 'Nos traductions techniques spécialisées sont réalisées par des traducteurs qualifiés issus de l’ingénierie. Locuteurs natifs de leur langue cible, ils allient expertise technique, précision linguistique et terminologie cohérente. Vous obtenez ainsi des traductions de haute qualité, techniquement correctes et compréhensibles, auprès d’un seul prestataire.', uk: 'Наші технічні фахові переклади виконують кваліфіковані перекладачі з інженерною освітою. Як носії цільової мови, вони поєднують технічну експертизу з мовною точністю та узгодженою фаховою термінологією. Так ви отримуєте якісні, фахово коректні та зрозумілі переклади з одного джерела.' },
  'Als spezialisiertes Fachübersetzungsbüro für Medizin und Dentalmedizin unterstützen wir Kliniken, Praxen, medizinische Einrichtungen, Dentalfirmen, Hersteller und Fachverlage mit präzisen und fachlich geprüften Übersetzungen.': { en: 'As a specialist translation office for medicine and dentistry, we support clinics, practices, medical institutions, dental companies, manufacturers and specialist publishers with precise, professionally checked translations.', ar: 'بصفتنا مكتب ترجمة متخصصا في الطب وطب الأسنان، ندعم العيادات والممارسات والمؤسسات الطبية وشركات الأسنان والمصنّعين ودور النشر المتخصصة بترجمات دقيقة ومراجعة تخصصيا.', tr: 'Tıp ve diş hekimliği alanında uzmanlaşmış çeviri bürosu olarak klinikleri, muayenehaneleri, tıbbi kurumları, dental firmaları, üreticileri ve uzman yayınevlerini hassas ve uzmanlarca kontrol edilmiş çevirilerle destekliyoruz.', ru: 'Как специализированное бюро переводов для медицины и стоматологии, мы поддерживаем клиники, практики, медицинские учреждения, стоматологические компании, производителей и профильные издательства точными и профессионально проверенными переводами.', fr: 'En tant que bureau de traduction spécialisé en médecine et dentisterie, nous accompagnons cliniques, cabinets, établissements médicaux, entreprises dentaires, fabricants et éditeurs spécialisés avec des traductions précises et vérifiées par des experts.', uk: 'Як спеціалізоване бюро перекладів для медицини та стоматології, ми підтримуємо клініки, практики, медичні заклади, стоматологічні компанії, виробників і профільні видавництва точними та фахово перевіреними перекладами.' },
  'Unsere Übersetzer verfügen über langjährige Erfahrung und eine akademische Ausbildung in ihrem jeweiligen Fachgebiet. Viele unserer Fachübersetzer sind Muttersprachler ihrer Zielsprache und beherrschen zusätzlich Deutsch auf muttersprachlichem Niveau. So verbinden wir fachliche Kompetenz mit sprachlicher Präzision und gewährleisten hochwertige Fachübersetzungen.': { en: 'Our translators have many years of experience and academic training in their respective fields. Many are native speakers of the target language and also command German at native-speaker level, combining subject expertise with linguistic precision.', ar: 'يمتلك مترجمونا سنوات طويلة من الخبرة وتأهيلا أكاديميا في مجالاتهم. كثير من مترجمينا المتخصصين متحدثون أصليون للغة الهدف ويتقنون الألمانية أيضا بمستوى متقدم جدا، وبذلك نجمع بين الكفاءة التخصصية والدقة اللغوية.', tr: 'Çevirmenlerimiz kendi uzmanlık alanlarında uzun yıllara dayanan deneyime ve akademik eğitime sahiptir. Uzman çevirmenlerimizin çoğu hedef dillerinin ana dili konuşanlarıdır ve ayrıca Almancaya ana dili düzeyinde hâkimdir. Böylece uzmanlık yetkinliğini dilsel hassasiyetle birleştirir ve yüksek kaliteli uzman çeviriler garanti ederiz.', ru: 'Наши переводчики обладают многолетним опытом и академическим образованием в своей области. Многие наши специализированные переводчики являются носителями целевого языка и дополнительно владеют немецким на уровне носителя. Так мы сочетаем профессиональную компетентность с языковой точностью и гарантируем качественные специализированные переводы.', fr: 'Nos traducteurs disposent d’une longue expérience et d’une formation universitaire dans leur domaine. Beaucoup sont locuteurs natifs de leur langue cible et maîtrisent en outre l’allemand à un niveau natif. Nous allions ainsi compétence spécialisée et précision linguistique pour garantir des traductions de haute qualité.', uk: 'Наші перекладачі мають багаторічний досвід та академічну освіту у своїй галузі. Багато наших фахових перекладачів є носіями цільової мови й додатково володіють німецькою на рівні носія. Так ми поєднуємо фахову компетентність із мовною точністю та гарантуємо якісні фахові переклади.' },
  'Als spezialisiertes Fachübersetzungsbüro für Pharmazie unterstützen wir Pharmaunternehmen, Apotheken, Kliniken, CROs (Clinical Research Organizations), Hersteller von Medizinprodukten sowie Behörden mit fachlich präzisen Arzneimittelübersetzungen.': { en: 'As a specialist translation office for pharmacy, we support pharmaceutical companies, pharmacies, clinics, CROs, medical device manufacturers and authorities with precise pharmaceutical translations.', ar: 'بصفتنا مكتب ترجمة متخصصا في الصيدلة، ندعم شركات الأدوية والصيدليات والعيادات ومنظمات الأبحاث السريرية ومصنّعي الأجهزة الطبية والجهات الحكومية بترجمات دوائية دقيقة.', tr: 'Eczacılık alanında uzmanlaşmış çeviri bürosu olarak ilaç şirketlerini, eczaneleri, klinikleri, CRO’ları (Klinik Araştırma Kuruluşları), tıbbi cihaz üreticilerini ve resmi kurumları teknik açıdan hassas ilaç çevirileriyle destekliyoruz.', ru: 'Как специализированное бюро переводов для фармацевтики, мы поддерживаем фармацевтические компании, аптеки, клиники, CRO (контрактные исследовательские организации), производителей медицинских изделий и органы власти профессионально точными переводами лекарственных средств.', fr: 'En tant que bureau de traduction spécialisé en pharmacie, nous accompagnons entreprises pharmaceutiques, pharmacies, cliniques, CRO (organisations de recherche clinique), fabricants de dispositifs médicaux et autorités avec des traductions pharmaceutiques précises.', uk: 'Як спеціалізоване бюро перекладів для фармацевтики, ми підтримуємо фармацевтичні компанії, аптеки, клініки, CRO (контрактні дослідницькі організації), виробників медичних виробів та органи влади фахово точними перекладами лікарських засобів.' },
  'Unsere pharmazeutischen Fachübersetzungen werden von qualifizierten Pharmazeuten aus unserem Team angefertigt, die ihre jeweilige Fremdsprache sowie Deutsch sicher beherrschen. Dadurch verbinden wir fundiertes pharmazeutisches Fachwissen mit sprachlicher Präzision und gewährleisten fachgerechte, hochwertige Übersetzungen.': { en: 'Our pharmaceutical specialist translations are prepared by qualified pharmacists in our team who have a strong command of both the foreign language and German. This combines pharmaceutical expertise with linguistic precision.', ar: 'تُنجز ترجماتنا الصيدلانية المتخصصة بواسطة صيادلة مؤهلين من فريقنا يتقنون اللغة الأجنبية المعنية والألمانية. وبذلك نجمع بين المعرفة الصيدلانية المتعمقة والدقة اللغوية.', tr: 'Farmasötik uzman çevirilerimiz, ilgili yabancı dile ve Almancaya güvenle hâkim olan ekibimizdeki nitelikli eczacılar tarafından hazırlanır. Böylece sağlam farmasötik uzmanlık bilgisini dilsel hassasiyetle birleştirir ve teknik açıdan doğru, yüksek kaliteli çeviriler garanti ederiz.', ru: 'Наши фармацевтические специализированные переводы выполняются квалифицированными фармацевтами из нашей команды, которые уверенно владеют соответствующим иностранным языком и немецким. Так мы сочетаем глубокие фармацевтические знания с языковой точностью и гарантируем профессиональные, качественные переводы.', fr: 'Nos traductions pharmaceutiques spécialisées sont réalisées par des pharmaciens qualifiés de notre équipe, qui maîtrisent avec assurance la langue étrangère concernée ainsi que l’allemand. Nous allions ainsi une solide expertise pharmaceutique à la précision linguistique pour garantir des traductions professionnelles de haute qualité.', uk: 'Наші фармацевтичні фахові переклади виконують кваліфіковані фармацевти з нашої команди, які впевнено володіють відповідною іноземною мовою та німецькою. Так ми поєднуємо ґрунтовні фармацевтичні знання з мовною точністю та гарантуємо фахові, якісні переклади.' },
  'Als Fachübersetzungsbüro für Literatur und Kultur unterstützen wir Verlage, Autorinnen und Autoren, Theater, Filmproduktionen, Kulturinstitutionen, Museen und Agenturen mit hochwertigen literarischen Übersetzungen.': { en: 'As a specialist translation office for literature and culture, we support publishers, authors, theatres, film productions, cultural institutions, museums and agencies with high-quality literary translations.', ar: 'بصفتنا مكتب ترجمة متخصصا في الأدب والثقافة، ندعم دور النشر والمؤلفين والمسارح والإنتاج السينمائي والمؤسسات الثقافية والمتاحف والوكالات بترجمات أدبية عالية الجودة.', tr: 'Edebiyat ve kültür alanında uzman çeviri bürosu olarak yayınevlerini, yazarları, tiyatroları, film yapımlarını, kültür kurumlarını, müzeleri ve ajansları yüksek kaliteli edebi çevirilerle destekliyoruz.', ru: 'Как специализированное бюро переводов для литературы и культуры, мы поддерживаем издательства, авторов, театры, кинопроизводство, учреждения культуры, музеи и агентства качественными литературными переводами.', fr: 'En tant que bureau de traduction spécialisé en littérature et culture, nous accompagnons éditeurs, auteurs, théâtres, productions cinématographiques, institutions culturelles, musées et agences avec des traductions littéraires de haute qualité.', uk: 'Як спеціалізоване бюро перекладів для літератури та культури, ми підтримуємо видавництва, авторів, театри, кінопродукцію, культурні установи, музеї та агентства якісними літературними перекладами.' },
  'Als Fachübersetzungsbüro für Chemie und Biowissenschaften unterstützen wir Chemieunternehmen, Labore, Forschungsinstitute, Hochschulen, Biotech-Unternehmen sowie Hersteller von Labor- und Analysegeräten mit präzisen wissenschaftlichen Übersetzungen.': { en: 'As a specialist translation office for chemistry and life sciences, we support chemical companies, laboratories, research institutes, universities, biotech companies and manufacturers of laboratory and analytical equipment with precise scientific translations.', ar: 'بصفتنا مكتب ترجمة متخصصا في الكيمياء وعلوم الحياة، ندعم الشركات الكيميائية والمختبرات ومعاهد البحث والجامعات وشركات التكنولوجيا الحيوية ومصنّعي أجهزة المختبر والتحليل بترجمات علمية دقيقة.', tr: 'Kimya ve yaşam bilimleri alanında uzman çeviri bürosu olarak kimya şirketlerini, laboratuvarları, araştırma enstitülerini, üniversiteleri, biyoteknoloji şirketlerini ve laboratuvar ile analiz cihazı üreticilerini hassas bilimsel çevirilerle destekliyoruz.', ru: 'Как специализированное бюро переводов в области химии и наук о жизни, мы поддерживаем химические компании, лаборатории, исследовательские институты, вузы, биотехнологические компании и производителей лабораторного и аналитического оборудования точными научными переводами.', fr: 'En tant que bureau de traduction spécialisé en chimie et sciences de la vie, nous accompagnons entreprises chimiques, laboratoires, instituts de recherche, universités, entreprises biotech et fabricants d’équipements de laboratoire et d’analyse avec des traductions scientifiques précises.', uk: 'Як спеціалізоване бюро перекладів у сфері хімії та наук про життя, ми підтримуємо хімічні компанії, лабораторії, дослідницькі інститути, університети, біотехнологічні компанії та виробників лабораторного й аналітичного обладнання точними науковими перекладами.' },
  'Als Übersetzungsbüro für IT, Software und Lokalisierung unterstützen wir Softwarehersteller, Start-ups, Agenturen, Systemhäuser und IT-Abteilungen bei der fachgerechten Übersetzung und Lokalisierung digitaler Produkte.': { en: 'As a translation office for IT, software and localization, we support software manufacturers, start-ups, agencies, system houses and IT departments with professional translation and localization of digital products.', ar: 'بصفتنا مكتب ترجمة لتقنية المعلومات والبرمجيات والتوطين، ندعم مصنّعي البرامج والشركات الناشئة والوكالات وشركات الأنظمة وأقسام تقنية المعلومات في الترجمة المتخصصة وتوطين المنتجات الرقمية.', tr: 'BT, yazılım ve yerelleştirme alanında çeviri bürosu olarak yazılım üreticilerini, girişimleri, ajansları, sistem evlerini ve BT departmanlarını dijital ürünlerin uzmanca çeviri ve yerelleştirilmesinde destekliyoruz.', ru: 'Как бюро переводов для IT, программного обеспечения и локализации, мы поддерживаем разработчиков ПО, стартапы, агентства, системных интеграторов и IT-отделы в профессиональном переводе и локализации цифровых продуктов.', fr: 'En tant que bureau de traduction pour l’IT, les logiciels et la localisation, nous accompagnons éditeurs de logiciels, start-ups, agences, sociétés de services informatiques et départements IT dans la traduction et la localisation professionnelles de produits numériques.', uk: 'Як бюро перекладів для IT, програмного забезпечення та локалізації, ми підтримуємо розробників ПЗ, стартапи, агентства, системних інтеграторів та IT-відділи у фаховому перекладі й локалізації цифрових продуктів.' },
  'Wir arbeiten mit XML-, YAML-, JSON-, PO-, XLIFF- und CSV-Dateien und integrieren uns auf Wunsch direkt in bestehende Lokalisierungs-Workflows, Git-Repositories und CI/CD-Pipelines.': { en: 'We work with XML, YAML, JSON, PO, XLIFF and CSV files and, on request, integrate directly into existing localization workflows, Git repositories and CI/CD pipelines.', ar: 'نعمل مع ملفات XML وYAML وJSON وPO وXLIFF وCSV، ونندمج عند الطلب مباشرة في سير عمل التوطين القائم ومستودعات Git وخطوط CI/CD.', tr: 'XML, YAML, JSON, PO, XLIFF ve CSV dosyalarıyla çalışıyor ve talep üzerine mevcut yerelleştirme iş akışlarına, Git depolarına ve CI/CD hatlarına doğrudan entegre oluyoruz.', ru: 'Мы работаем с файлами XML, YAML, JSON, PO, XLIFF и CSV и по запросу интегрируемся напрямую в существующие процессы локализации, Git-репозитории и CI/CD-конвейеры.', fr: 'Nous travaillons avec des fichiers XML, YAML, JSON, PO, XLIFF et CSV et nous intégrons sur demande directement aux workflows de localisation, dépôts Git et pipelines CI/CD existants.', uk: 'Ми працюємо з файлами XML, YAML, JSON, PO, XLIFF і CSV та за запитом інтегруємося безпосередньо в наявні процеси локалізації, Git-репозиторії та CI/CD-конвеєри.' },
  'Unsere IT-Fachübersetzer verfügen über fundiertes technisches Verständnis in den Bereichen Softwareentwicklung, Cloud-Infrastruktur, IT-Sicherheit, Datenbanken und DevOps. Dadurch stellen wir sicher, dass Benutzeroberflächen, Fehlermeldungen, Tooltips, technische Dokumentationen und Softwareinhalte nicht nur sprachlich präzise, sondern auch fachlich korrekt, konsistent und benutzerfreundlich übersetzt werden.': { en: 'Our IT specialist translators have sound technical understanding in software development, cloud infrastructure, IT security, databases and DevOps. This ensures that user interfaces, error messages, tooltips, technical documentation and software content are translated not only precisely, but also correctly, consistently and user-friendly.', ar: 'يمتلك مترجمونا المتخصصون في تقنية المعلومات فهما تقنيا راسخا في تطوير البرمجيات والبنية السحابية وأمن المعلومات وقواعد البيانات وDevOps. لذلك نضمن ترجمة الواجهات ورسائل الخطأ والتلميحات والوثائق التقنية ومحتوى البرمجيات بدقة لغوية وصحة تخصصية واتساق وسهولة استخدام.', tr: 'BT uzman çevirmenlerimiz yazılım geliştirme, bulut altyapısı, BT güvenliği, veritabanları ve DevOps alanlarında sağlam teknik anlayışa sahiptir. Böylece kullanıcı arayüzlerinin, hata mesajlarının, araç ipuçlarının, teknik dokümantasyonun ve yazılım içeriklerinin yalnızca dilsel açıdan hassas değil, aynı zamanda teknik açıdan doğru, tutarlı ve kullanıcı dostu şekilde çevrilmesini sağlarız.', ru: 'Наши IT-переводчики обладают глубоким техническим пониманием в области разработки ПО, облачной инфраструктуры, IT-безопасности, баз данных и DevOps. Благодаря этому мы гарантируем, что интерфейсы, сообщения об ошибках, всплывающие подсказки, техническая документация и содержимое ПО переводятся не только точно с языковой точки зрения, но и профессионально корректно, последовательно и удобно для пользователя.', fr: 'Nos traducteurs spécialisés en IT possèdent une solide compréhension technique du développement logiciel, de l’infrastructure cloud, de la sécurité IT, des bases de données et du DevOps. Nous garantissons ainsi que les interfaces, messages d’erreur, infobulles, documentations techniques et contenus logiciels sont traduits non seulement avec précision linguistique, mais aussi de manière techniquement correcte, cohérente et conviviale.', uk: 'Наші IT-перекладачі мають ґрунтовне технічне розуміння у сферах розробки ПЗ, хмарної інфраструктури, IT-безпеки, баз даних і DevOps. Завдяки цьому ми гарантуємо, що інтерфейси, повідомлення про помилки, підказки, технічна документація та вміст ПЗ перекладаються не лише мовно точно, а й фахово коректно, послідовно та зручно для користувача.' },
  'Als deutschlandweit tätiges IT-Übersetzungsbüro unterstützen wir Unternehmen, Start-ups, Softwarehersteller und IT-Dienstleister in Städten wie Berlin, Hamburg, München, Stuttgart, Hannover, Frankfurt, Köln und Osnabrück sowie Remote-Teams in ganz Europa.': { en: 'As an IT translation office active throughout Germany, we support companies, start-ups, software manufacturers and IT service providers in cities such as Berlin, Hamburg, Munich, Stuttgart, Hanover, Frankfurt, Cologne and Osnabrück, as well as remote teams across Europe.', ar: 'بصفتنا مكتب ترجمة لتقنية المعلومات يعمل في جميع أنحاء ألمانيا، ندعم الشركات والشركات الناشئة ومصنّعي البرمجيات ومقدمي خدمات تقنية المعلومات في مدن مثل برلين وهامبورغ وميونخ وشتوتغارت وهانوفر وفرانكفورت وكولونيا وأوسنابروك، وكذلك الفرق البعيدة في كل أوروبا.', tr: 'Almanya genelinde faaliyet gösteren bir BT çeviri bürosu olarak Berlin, Hamburg, Münih, Stuttgart, Hannover, Frankfurt, Köln ve Osnabrück gibi şehirlerdeki şirketleri, girişimleri, yazılım üreticilerini ve BT hizmet sağlayıcılarını ve ayrıca tüm Avrupa’daki uzaktan ekipleri destekliyoruz.', ru: 'Как IT-бюро переводов, работающее по всей Германии, мы поддерживаем компании, стартапы, разработчиков ПО и IT-провайдеров в таких городах, как Берлин, Гамбург, Мюнхен, Штутгарт, Ганновер, Франкфурт, Кёльн и Оснабрюк, а также удаленные команды по всей Европе.', fr: 'En tant que bureau de traduction IT actif dans toute l’Allemagne, nous accompagnons entreprises, start-ups, éditeurs de logiciels et prestataires IT dans des villes comme Berlin, Hambourg, Munich, Stuttgart, Hanovre, Francfort, Cologne et Osnabrück, ainsi que des équipes à distance dans toute l’Europe.', uk: 'Як IT-бюро перекладів, що працює по всій Німеччині, ми підтримуємо компанії, стартапи, розробників ПЗ та IT-провайдерів у таких містах, як Берлін, Гамбург, Мюнхен, Штутгарт, Ганновер, Франкфурт, Кельн і Оснабрюк, а також віддалені команди по всій Європі.' },
  'Teilen Sie uns einfach mit, welche Inhalte übersetzt werden sollen, in welche Sprache die Übersetzung erfolgen soll und ob besondere Anforderungen an Terminologie, Format oder Lokalisierung bestehen. Auf dieser Grundlage erhalten Sie von uns zeitnah ein kostenloses und unverbindliches Angebot mit transparenten Konditionen und einer realistischen Lieferzeit.': { en: 'Simply tell us which content should be translated, into which language, and whether there are special requirements for terminology, format or localization. On this basis, you will promptly receive a free, non-binding offer with transparent conditions and a realistic delivery time.', ar: 'أخبرونا ببساطة بالمحتوى المطلوب ترجمته، واللغة المطلوبة، وما إذا كانت هناك متطلبات خاصة للمصطلحات أو التنسيق أو التوطين. وبناء على ذلك تحصلون سريعا على عرض مجاني وغير ملزم بشروط واضحة ومدة تسليم واقعية.', tr: 'Hangi içeriklerin çevrileceğini, çevirinin hangi dile yapılacağını ve terminoloji, format veya yerelleştirmeye ilişkin özel gereksinimler olup olmadığını bize bildirmeniz yeterli. Bu temelde, şeffaf koşullar ve gerçekçi bir teslim süresiyle ücretsiz ve bağlayıcı olmayan bir teklifi kısa sürede tarafımızdan alırsınız.', ru: 'Просто сообщите нам, какое содержание нужно перевести, на какой язык должен выполняться перевод и есть ли особые требования к терминологии, формату или локализации. На этой основе вы оперативно получите от нас бесплатное предложение без обязательств с прозрачными условиями и реалистичным сроком выполнения.', fr: 'Indiquez-nous simplement quels contenus doivent être traduits, dans quelle langue et s’il existe des exigences particulières en matière de terminologie, de format ou de localisation. Sur cette base, vous recevrez rapidement de notre part une offre gratuite et sans engagement, avec des conditions transparentes et un délai de livraison réaliste.', uk: 'Просто повідомте нам, який вміст потрібно перекласти, якою мовою має виконуватися переклад і чи є особливі вимоги до термінології, формату або локалізації. На цій основі ви оперативно отримаєте від нас безкоштовну та необов’язкову пропозицію з прозорими умовами й реалістичним терміном виконання.' },
});
