// Service page content extracted from Services.jsx. German stays the master source; language variants live beside the same keys.

export const IT_ASSET_BASE = '/assets/it-software/';
export const DOLMETSCHER_ASSET_BASE = '/assets/dolmetscher/';
export const BEEIDIGTE_ASSET_BASE = '/assets/beeidigte-dolmetscher/';
export const RECHT_ASSET_BASE = '/assets/recht/';
export const STANDESAMT_ASSET_BASE = '/assets/standesamt-dolmetscher/';
export const WIRTSCHAFT_ASSET_BASE = '/assets/wirtschaft-finanzen/';
export const BEGLAUBIGTE_ASSET_BASE = '/assets/beglaubigte-uebersetzung/';
export const POINT_CONTENT_ASSET_BASE = '/assets/points-content/';

export const DOLMETSCHER_SHEET = {
...
export const DOLMETSCHER_SHEET_BY_LANG = {
...
export const BEEIDIGTE_DOLMETSCHER_SHEET = {
  kicker: 'Dolmetschen',
...
export const STANDESAMT_DOLMETSCHER_SHEET = {
  kicker: 'Dolmetschen',
...
export const WIRTSCHAFT_FINANZEN_SHEET = {
...
export const BEGLAUBIGTE_UEBERSETZUNG_SHEET = {
...
export const POINT_GRID_SHEETS = {
  simultandolmetscher: {
...
export const IT_SOFTWARE_SHEET = {
  title: 'IT & Software',
  sections: [
    {
